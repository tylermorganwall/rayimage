...
#'@param vignette Default `1`. A camera vignetting effect will be added to the image.
...
#'@param radius Default `1.1`. Multiplier for the size of the vignette. If `1`, the vignette touches

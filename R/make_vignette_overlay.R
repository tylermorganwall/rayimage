...
#'@keywords internal
make_vignette_overlay = function(width, height, intensity=0.3, radius=NULL,color = "#000000") {
  ...
  imageval %>%
    magick::image_border(paste0(color,as.hexmode(as.integer(intensity*255))), paste0(radius,"x",radius)) %>%

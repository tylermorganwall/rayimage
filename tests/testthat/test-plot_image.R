...
test_that("Checking plot_image_grid", {
  # skip_on_os(c("windows", "linux", "solaris"))
  plt_img_args = expand.grid(
    input_list = list(list(dragon, NULL, NULL, dragon)),
...
test_that("checking print functions", {
  ...
  expect_no_error(print(dragon_print1[,, 3]))
  expect_no_error(print(dragon_print1[,, 4]))
  expect_no_error(print(dragon_print1[,, c(1, 3)]))
  ...
  expect_no_error(print(dragon_print1[1:10, , 2]))
  expect_no_error(print(dragon_print1[1:10, , 3]))
  expect_no_error(print(dragon_print1[1:10, , 4]))
  expect_no_error(print(dragon_print1[1:10, , c(1, 3)]))
  ...
  expect_no_error(print(dragon_print1[1:10, 1:10, 2]))
  expect_no_error(print(dragon_print1[1:10, 1:10, 3]))
  expect_no_error(print(dragon_print1[1:10, 1:10, 4]))
  expect_no_error(print(dragon_print1[1:10, 1:10, c(1, 3)]))
  ...
  expect_no_error(print(dragon_print1[1, 1:10, 1]))
  expect_no_error(print(dragon_print1[1, 1:10, 2]))
  expect_no_error(print(dragon_print1[1, 1:10, 3]))
  expect_no_error(print(dragon_print1[1, 1:10, 4]))
  expect_no_error(print(dragon_print1[1, 1:10, c(1, 3)]))
